...
- **Please review the project file called checkout-notes.md to see important information regarding proper and improper entries to test form validation for the simulated checkout sequence.**
